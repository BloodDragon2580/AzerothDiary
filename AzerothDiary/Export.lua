...
:root{color-scheme:dark;--bg:#080b12;--panel:#101625;--panel2:#161e30;--line:#28344e;--text:#eef2ff;--muted:#99a6c1;--gold:#d9ad5b;--blue:#69a7ff;--violet:#9a7cff;--green:#73d39b}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 15% 0,#17213a 0,#080b12 34%,#05070c 100%);color:var(--text);font-family:Inter,Segoe UI,Arial,sans-serif;min-height:100vh}.wrap{max-width:1180px;margin:auto;padding:42px 20px 70px}.hero{padding:34px;border:1px solid var(--line);border-radius:22px;background:linear-gradient(135deg,rgba(217,173,91,.10),rgba(105,167,255,.04)),rgba(16,22,37,.92)}h1{font-size:clamp(2.1rem,5vw,4rem);margin:0 0 8px;letter-spacing:-.04em}.tag{color:var(--gold);font-weight:700}.muted{color:var(--muted)}.stats{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin:20px 0}.stat{padding:18px;border:1px solid var(--line);border-radius:16px;background:var(--panel)}.stat b{display:block;font-size:1.7rem;margin-top:4px}.tools{display:grid;grid-template-columns:2fr 1fr 1fr;gap:10px;margin:24px 0 12px}.tools input,.tools select,.calendar-controls select{width:100%;padding:13px 14px;border-radius:12px;border:1px solid var(--line);background:#0b1020;color:var(--text);font-size:1rem}.calendar{margin:0 0 24px;padding:18px;border:1px solid var(--line);border-radius:16px;background:rgba(16,22,37,.92)}.calendar-head{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:14px}.calendar-title{font-weight:800;color:var(--gold);font-size:.82rem;letter-spacing:.08em;text-transform:uppercase}.calendar-subtitle{margin-top:3px;color:var(--muted);font-size:.9rem}.calendar-controls{display:grid;grid-template-columns:150px 180px 140px auto;gap:8px;align-items:center}.calendar-controls button{min-height:47px;padding:10px 14px;border:1px solid var(--line);border-radius:12px;background:var(--panel2);color:var(--text);cursor:pointer}.calendar-controls button:hover,.calendar-controls button:focus-visible{border-color:var(--gold);color:var(--gold)}.calendar-weekdays,.calendar-days{display:grid;grid-template-columns:repeat(7,1fr);gap:6px}.calendar-weekdays{margin-top:8px}.calendar-weekdays span{text-align:center;color:var(--muted);font-size:.74rem;font-weight:700;padding:4px}.calendar-days{margin-top:4px}.calendar-day{position:relative;min-height:54px;border:1px solid var(--line);border-radius:10px;background:#0b1020;color:var(--text);cursor:pointer;font-weight:700}.calendar-day:hover:not(:disabled),.calendar-day:focus-visible{border-color:var(--gold);color:var(--gold)}.calendar-day:disabled{opacity:.22;cursor:default}.calendar-day.active{background:var(--gold);border-color:var(--gold);color:#111827}.calendar-day .count{position:absolute;right:6px;bottom:4px;font-size:.68rem;color:var(--muted);font-weight:600}.calendar-day.active .count{color:#374151}.calendar-blank{min-height:54px}.calendar-message{grid-column:1/-1;text-align:center;padding:18px;color:var(--muted);border:1px dashed var(--line);border-radius:10px}.timeline{display:grid;gap:12px}.memory{display:grid;grid-template-columns:54px 1fr auto;gap:15px;align-items:start;padding:18px;border:1px solid var(--line);border-radius:16px;background:rgba(16,22,37,.92)}.memory[hidden]{display:none!important}.ico{display:grid;place-items:center;width:50px;height:50px;border-radius:14px;background:var(--panel2);font-size:1.55rem}.kind{font-size:.75rem;letter-spacing:.08em;text-transform:uppercase;color:var(--gold);font-weight:800}.memory h2{font-size:1.05rem;margin:4px 0}.wh-link{color:var(--gold);text-decoration:none;border-bottom:1px dotted rgba(217,173,91,.55)}.wh-link:hover,.wh-link:focus{color:#f3ca7a;border-bottom-color:#f3ca7a}.detail{color:var(--muted);line-height:1.5;white-space:pre-wrap}.where{margin-top:8px;color:#7f8da9;font-size:.86rem}.when{text-align:right;color:var(--muted);font-size:.84rem;white-space:nowrap}.char{color:var(--blue);font-weight:700;margin-top:5px}.empty{display:none;padding:40px;text-align:center;border:1px dashed var(--line);border-radius:16px;color:var(--muted)}.pager{display:flex;align-items:center;justify-content:center;gap:10px;flex-wrap:wrap;margin:24px 0 4px}.pager[hidden]{display:none!important}.pager button{min-width:44px;min-height:42px;padding:9px 13px;border:1px solid var(--line);border-radius:11px;background:var(--panel);color:var(--text);font-size:.92rem;cursor:pointer}.pager button:hover:not(:disabled),.pager button:focus-visible{border-color:var(--gold);color:var(--gold)}.pager button:disabled{opacity:.38;cursor:not-allowed}.page-numbers{display:flex;gap:6px;align-items:center;flex-wrap:wrap;justify-content:center}.page-numbers button.active{background:var(--gold);border-color:var(--gold);color:#111827;font-weight:800}.page-ellipsis{color:var(--muted);padding:0 2px}.page-info{width:100%;text-align:center;color:var(--muted);font-size:.86rem;margin-top:2px}footer{margin-top:32px;text-align:center;color:#72809c;font-size:.85rem}@media(max-width:760px){.stats{grid-template-columns:1fr 1fr}.tools{grid-template-columns:1fr}.calendar-head{align-items:stretch;flex-direction:column}.calendar-controls{grid-template-columns:1fr 1fr}.calendar-day,.calendar-blank{min-height:46px}.memory{grid-template-columns:46px 1fr}.when{grid-column:2;text-align:left}.hero{padding:24px}.pager{gap:7px}.pager button{padding:8px 11px}}@media(max-width:420px){.stats{grid-template-columns:1fr}.wrap{padding:20px 12px 50px}.calendar-controls{grid-template-columns:1fr}.calendar-day,.calendar-blank{min-height:42px}.calendar-day .count{display:none}}
    ...
    add("</select></section>")
    add("<section class=\"calendar\" aria-label=\"" .. attrEscape(self:L("HTML_DATE_FILTER")) .. "\"><div class=\"calendar-head\"><div><div class=\"calendar-title\">" .. htmlEscape(self:L("HTML_CALENDAR")) .. "</div><div class=\"calendar-subtitle\">" .. htmlEscape(self:L("HTML_CALENDAR_HINT")) .. "</div></div><div class=\"calendar-controls\">")
    add("<select id=\"year\" aria-label=\"" .. attrEscape(self:L("HTML_YEAR")) .. "\"><option value=\"\">" .. htmlEscape(self:L("HTML_ALL_YEARS")) .. "</option>")
    local years, seenYears = {}, {}
    for _, entry in ipairs(entries) do
        local year = date("%Y", entry.ts)
        if year and not seenYears[year] then
            seenYears[year] = true
            years[#years + 1] = year
        end
    end
    table.sort(years, function(a, b) return a > b end)
    for _, yearValue in ipairs(years) do
        add("<option value=\"" .. attrEscape(yearValue) .. "\">" .. htmlEscape(yearValue) .. "</option>")
    end
    add("</select><select id=\"month\" aria-label=\"" .. attrEscape(self:L("HTML_MONTH")) .. "\"><option value=\"\">" .. htmlEscape(self:L("HTML_ALL_MONTHS")) .. "</option></select>")
    add("<select id=\"day\" aria-label=\"" .. attrEscape(self:L("HTML_DAY")) .. "\" disabled><option value=\"\">" .. htmlEscape(self:L("HTML_ALL_DAYS")) .. "</option></select>")
    add("<button id=\"clearDate\" type=\"button\">" .. htmlEscape(self:L("HTML_CLEAR_DATE")) .. "</button></div></div><div id=\"calendarWeekdays\" class=\"calendar-weekdays\"></div><div id=\"calendarDays\" class=\"calendar-days\"></div></section>")
    add("<section id=\"timeline\" class=\"timeline\">")
    ...
    for _, entry in ipairs(entries) do
        ...
        local entryYear = date("%Y", entry.ts)
        local entryMonth = date("%m", entry.ts)
        local entryDay = date("%d", entry.ts)
        add("<article class=\"memory\" data-cat=\"" .. attrEscape(entry.kind) .. "\" data-char=\"" .. attrEscape(entry.charKey or "") .. "\" data-search=\"" .. attrEscape(searchBlob) .. "\" data-year=\"" .. attrEscape(entryYear) .. "\" data-month=\"" .. attrEscape(entryMonth) .. "\" data-day=\"" .. attrEscape(entryDay) .. "\">")
...
const pageSize=20,pageLabel=]] .. string.format('%q', self:L("HTML_PAGE")) .. [[,memoriesLabel=]] .. string.format('%q', self:L("HTML_MEMORIES")) .. [[,allDaysLabel=]] .. string.format('%q', self:L("HTML_ALL_DAYS")) .. [[,calendarSelectLabel=]] .. string.format('%q', self:L("HTML_CALENDAR_SELECT_MONTH")) .. [[;let currentPage=1;
const locale=document.documentElement.lang==='de'?'de-DE':'en-US';
for(let number=1;number<=12;number++){const option=document.createElement('option');option.value=String(number).padStart(2,'0');option.textContent=new Intl.DateTimeFormat(locale,{month:'long'}).format(new Date(2026,number-1,1));month.appendChild(option)}
function renderWeekdays(){calendarWeekdays.textContent='';const formatter=new Intl.DateTimeFormat(locale,{weekday:'short'});const monday=new Date(2026,0,5);for(let index=0;index<7;index++){const span=document.createElement('span');const d=new Date(monday);d.setDate(monday.getDate()+index);span.textContent=formatter.format(d);calendarWeekdays.appendChild(span)}}
function matchesBase(el){const s=q.value.trim().toLocaleLowerCase(),c=cat.value,h=chr.value;const rawSearch=el.dataset.search?el.dataset.search:'';const searchOk=s===''?true:rawSearch.toLocaleLowerCase().includes(s);const categoryOk=c===''?true:el.dataset.cat===c;const characterOk=h===''?true:el.dataset.char===h;return searchOk&&categoryOk&&characterOk}
function matches(el){if(!matchesBase(el))return false;const y=year.value,m=month.value,d=day.value;const yearOk=y===''?true:el.dataset.year===y;const monthOk=m===''?true:el.dataset.month===m;const dayOk=d===''?true:el.dataset.day===d;return yearOk&&monthOk&&dayOk}
function rebuildDaySelect(){const selected=day.value;day.textContent='';const allOption=document.createElement('option');allOption.value='';allOption.textContent=allDaysLabel;day.appendChild(allOption);if(year.value!==''&&month.value!==''){const maxDay=new Date(Number(year.value),Number(month.value),0).getDate();for(let number=1;number<=maxDay;number++){const option=document.createElement('option');option.value=String(number).padStart(2,'0');option.textContent=String(number);day.appendChild(option)}day.disabled=false;if(selected!==''&&Number(selected)<=maxDay)day.value=selected}else{day.disabled=true;day.value=''}}
function renderCalendar(){calendarDays.textContent='';if(!(year.value!==''&&month.value!=='')){const message=document.createElement('div');message.className='calendar-message';message.textContent=calendarSelectLabel;calendarDays.appendChild(message);return}const y=Number(year.value),m=Number(month.value),maxDay=new Date(y,m,0).getDate(),first=(new Date(y,m-1,1).getDay()+6)%7;for(let blank=0;blank<first;blank++){const spacer=document.createElement('div');spacer.className='calendar-blank';calendarDays.appendChild(spacer)}const baseCards=cards.filter(matchesBase);for(let number=1;number<=maxDay;number++){const value=String(number).padStart(2,'0');let count=0;for(const el of baseCards){if(el.dataset.year===year.value&&el.dataset.month===month.value&&el.dataset.day===value)count++}const button=document.createElement('button');button.type='button';button.className='calendar-day';if(day.value===value)button.className+=' active';button.disabled=count===0;button.innerHTML='<span>'+number+'</span><span class="count">'+count+'</span>';button.addEventListener('click',function(){day.value=day.value===value?'':value;render(true)});calendarDays.appendChild(button)}}
